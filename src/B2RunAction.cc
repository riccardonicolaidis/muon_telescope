...
{ 
  ...
  //G4RunManager::GetRunManager()->SetPrintProgress(1000);     
  	...
  	fMessenger = new G4GenericMessenger(this, "/configuration/","Choose the configuration of the instrument");
  	G4int CONFIGURATION = 1;
  	fMessenger -> DeclareProperty("CONFIGURATION", CONFIGURATION, "Select the configuration");

	G4String NAME = "file_" + std::to_string(CONFIGURATION);
